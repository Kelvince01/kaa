...
import { getCurrentWindow, invoke } from "@kaa/desktop-client/core";
import { isDesktopApp, listenForDeepLinks } from "@kaa/desktop-client/platform";
...
export function DesktopProvider() {
  ...
  useEffect(() => {
    ...
    const SHOW_WINDOW_DELAY = 300;
    const timer = setTimeout(showWindow, SHOW_WINDOW_DELAY);
