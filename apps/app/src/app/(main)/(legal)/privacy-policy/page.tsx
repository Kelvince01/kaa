			...
			<div className="container mx-auto max-w-4xl px-4 py-8">
				<div className="mb-12 text-center">
					<div className="mb-6 inline-flex items-center gap-3">
						<div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600">
							<Icon icon="mdi:shield-check" className="h-6 w-6 text-white" />
						</div>
					...
					<p className="mx-auto max-w-2xl text-lg text-muted-foreground">
						Your privacy is our priority. Learn how we protect and handle your data on Kenya's
						leading AI-powered property rental platform.
					</p>
				...
				<div className="space-y-8">
					<Card className="border-emerald-200 pt-0 shadow-lg">
						<CardHeader className="rounded-t-lg bg-gradient-to-r from-emerald-500 to-teal-600 p-4 text-white">
							...
							<CardDescription className="text-emerald-100">
								Understanding what data we collect and why it matters for your rental experience
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6 px-6 pb-4">
							<div className="grid gap-6 md:grid-cols-2">
								<div className="space-y-4">
									<div className="flex items-start gap-3">
										<div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-emerald-100">
											<Icon icon="mdi:account" className="h-4 w-4 text-emerald-600" />
										</div>
										<div>
											<h4 className="font-semibold text-foreground">Personal Information</h4>
											<p className="text-muted-foreground text-sm">
												Name, email, phone number, and ID verification for secure transactions
											</p>
										</div>
									</div>
									<div className="flex items-start gap-3">
										<div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-emerald-100">
											<Icon icon="mdi:map-marker" className="h-4 w-4 text-emerald-600" />
										</div>
										<div>
											<h4 className="font-semibold text-foreground">Location Data</h4>
											<p className="text-muted-foreground text-sm">
												GPS coordinates to show nearby properties and improve search results
											</p>
										</div>
									</div>
								</div>
								<div className="space-y-4">
									<div className="flex items-start gap-3">
										<div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-emerald-100">
											<Icon icon="mdi:robot" className="h-4 w-4 text-emerald-600" />
										</div>
										<div>
											<h4 className="font-semibold text-foreground">AI Interaction Data</h4>
											<p className="text-muted-foreground text-sm">
												Chat logs with our AI assistant to improve recommendations
											</p>
										</div>
									</div>
									<div className="flex items-start gap-3">
										<div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-emerald-100">
											<Icon icon="mdi:credit-card" className="h-4 w-4 text-emerald-600" />
										</div>
										<div>
											<h4 className="font-semibold text-foreground">Payment Information</h4>
											<p className="text-muted-foreground text-sm">
												M-Pesa details and transaction history for seamless payments
											</p>
										</div>
									</div>
								</div>
					...
					<Card className="border-emerald-200 pt-0 shadow-lg">
						<CardHeader className="rounded-t-lg bg-gradient-to-r from-teal-500 to-emerald-600 p-4 text-white">
							...
							<CardDescription className="text-teal-100">
								Leveraging AI and machine learning to enhance your property search experience
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6 px-6 pb-4">
							<div className="grid gap-4">
								<div className="flex items-center gap-4 rounded-lg bg-emerald-50 p-4">
									<Icon icon="mdi:brain" className="h-6 w-6 text-emerald-600" />
									<div>
										<h4 className="font-semibold text-foreground">AI-Powered Recommendations</h4>
										<p className="text-muted-foreground text-sm">
											Our machine learning algorithms analyze your preferences to suggest perfect
											rental matches
										</p>
									</div>
								</div>
								<div className="flex items-center gap-4 rounded-lg bg-emerald-50 p-4">
									...
									<div>
										<h4 className="font-semibold text-foreground">Fraud Prevention</h4>
										<p className="text-muted-foreground text-sm">
											Advanced AI systems detect suspicious activities to protect all users in the
											Kenyan market
										</p>
									</div>
								</div>
								<div className="flex items-center gap-4 rounded-lg bg-emerald-50 p-4">
									<Icon icon="mdi:chart-line" className="h-6 w-6 text-emerald-600" />
									<div>
										<h4 className="font-semibold text-foreground">Market Insights</h4>
										<p className="text-muted-foreground text-sm">
											Analyze rental trends across Nairobi, Mombasa, and other Kenyan cities for
											better pricing
										</p>
									</div>
								</div>
					...
					<Card className="border-emerald-200 shadow-lg">
						<CardHeader>
							<CardTitle className="flex items-center gap-3 text-emerald-700">
								<Icon icon="mdi:account-cog" className="h-5 w-5" />
								Your Rights Under Kenyan Law
							</CardTitle>
							<CardDescription>
								In compliance with the Data Protection Act 2019, you have the following rights
							</CardDescription>
						</CardHeader>
						<CardContent className="px-6">
							<div className="grid gap-4 md:grid-cols-3">
								<div className="rounded-lg bg-emerald-50 p-4 text-center">
									<Icon icon="mdi:eye" className="mx-auto mb-2 h-8 w-8 text-emerald-600" />
									<h4 className="mb-1 font-semibold text-foreground">Access</h4>
									<p className="text-muted-foreground text-xs">View all data we have about you</p>
								</div>
								<div className="rounded-lg bg-emerald-50 p-4 text-center">
									<Icon icon="mdi:pencil" className="mx-auto mb-2 h-8 w-8 text-emerald-600" />
									<h4 className="mb-1 font-semibold text-foreground">Rectification</h4>
									<p className="text-muted-foreground text-xs">
										Correct any inaccurate information
									</p>
								</div>
								<div className="rounded-lg bg-emerald-50 p-4 text-center">
									<Icon icon="mdi:delete" className="mx-auto mb-2 h-8 w-8 text-emerald-600" />
									<h4 className="mb-1 font-semibold text-foreground">Erasure</h4>
									<p className="text-muted-foreground text-xs">Request deletion of your data</p>
								</div>
							</div>
						</CardContent>
					</Card>
					<Card className="border-emerald-200 bg-gradient-to-r from-emerald-500 to-teal-600 text-white shadow-lg">
						<CardContent className="px-6 py-8 text-center">
							<Icon icon="mdi:phone" className="mx-auto mb-4 h-12 w-12 text-emerald-100" />
							<h3 className="mb-2 font-bold font-heading text-xl">Questions About Your Privacy?</h3>
				...
				<div className="mt-12 text-center">
					<div className="inline-flex items-center gap-2 rounded-full bg-emerald-100 px-4 py-2">
						<Icon icon="mdi:shield-check" className="h-4 w-4 text-emerald-600" />
						<span className="font-medium text-emerald-700 text-sm">
