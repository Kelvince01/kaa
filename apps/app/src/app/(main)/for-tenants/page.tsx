				...
				<div className="container mx-auto text-center">
					<div className="mx-auto max-w-4xl">
						...
						<p className="mx-auto mb-8 max-w-2xl text-emerald-700 text-xl">
							Discover rental properties across Kenya with our AI-powered platform. From Nairobi
							apartments to Mombasa villas, find your ideal home with intelligent matching and
							virtual tours.
						</p>
						...
						<div className="mx-auto grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-3">
							<Card className="border-emerald-200 bg-white/80 backdrop-blur-sm transition-shadow hover:shadow-lg">
								<CardContent className="px-6 py-6 text-center">
									<div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100">
										<Icon icon="mdi:robot" className="h-6 w-6 text-emerald-600" />
									</div>
									<h3 className="mb-2 font-heading font-semibold text-emerald-900">AI Matching</h3>
									<p className="text-emerald-700 text-sm">
										Smart algorithms match you with properties based on your preferences and
										lifestyle
									</p>
								</CardContent>
							</Card>
							<Card className="border-emerald-200 bg-white/80 backdrop-blur-sm transition-shadow hover:shadow-lg">
								<CardContent className="px-6 py-6 text-center">
									<div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100">
										<Icon icon="mdi:virtual-reality" className="h-6 w-6 text-emerald-600" />
									</div>
									<h3 className="mb-2 font-heading font-semibold text-emerald-900">
										Virtual Tours
									</h3>
									<p className="text-emerald-700 text-sm">
										Explore properties from anywhere with immersive 360° virtual tours
									</p>
								</CardContent>
							</Card>
							<Card className="border-emerald-200 bg-white/80 backdrop-blur-sm transition-shadow hover:shadow-lg">
								<CardContent className="px-6 py-6 text-center">
									<div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100">
										<Icon icon="mdi:shield-check" className="h-6 w-6 text-emerald-600" />
									</div>
									<h3 className="mb-2 font-heading font-semibold text-emerald-900">
										Verified Listings
									</h3>
									<p className="text-emerald-700 text-sm">
										All properties are verified and vetted for authenticity and quality
									</p>
								</CardContent>
							</Card>
						</div>
						...
						<Card className="overflow-hidden border-emerald-200 bg-white transition-shadow hover:shadow-xl">
							<div className="relative">
								...
								<Badge className="absolute top-3 left-3 bg-emerald-600 text-white">
									<Icon icon="mdi:star" className="mr-1 h-3 w-3" />
									Featured
								</Badge>
								<div className="absolute top-3 right-3 rounded-full bg-white/90 p-2 backdrop-blur-sm">
									<Icon icon="mdi:heart-outline" className="h-4 w-4 text-emerald-600" />
								</div>
							</div>
							<CardContent className="px-6 py-4">
								<div className="mb-2 flex items-center justify-between">
									<h3 className="font-semibold text-emerald-900">Modern 2BR Apartment</h3>
									<span className="font-bold text-emerald-600">KES 85,000</span>
								</div>
								<p className="mb-3 flex items-center text-emerald-700 text-sm">
									<Icon icon="mdi:map-marker" className="mr-1 h-4 w-4" />
									Westlands, Nairobi
								</p>
								<div className="flex items-center justify-between text-emerald-600 text-sm">
									<span className="flex items-center">
										<Icon icon="mdi:bed" className="mr-1 h-4 w-4" />2 Beds
									</span>
									<span className="flex items-center">
										<Icon icon="mdi:shower" className="mr-1 h-4 w-4" />2 Baths
									</span>
									<span className="flex items-center">
										<Icon icon="mdi:car" className="mr-1 h-4 w-4" />
										Parking
									</span>
								</div>
							</CardContent>
						...
						<Card className="overflow-hidden border-emerald-200 bg-white transition-shadow hover:shadow-xl">
							<div className="relative">
								...
								<Badge className="absolute top-3 left-3 bg-teal-600 text-white">
									<Icon icon="mdi:home-variant" className="mr-1 h-3 w-3" />
									Villa
								</Badge>
								<div className="absolute top-3 right-3 rounded-full bg-white/90 p-2 backdrop-blur-sm">
									<Icon icon="mdi:heart-outline" className="h-4 w-4 text-emerald-600" />
							...
							<CardContent className="px-6 py-4">
								<div className="mb-2 flex items-center justify-between">
									<h3 className="font-semibold text-emerald-900">Beachfront Villa</h3>
									<span className="font-bold text-emerald-600">KES 120,000</span>
								</div>
								<p className="mb-3 flex items-center text-emerald-700 text-sm">
									<Icon icon="mdi:map-marker" className="mr-1 h-4 w-4" />
									Diani Beach, Mombasa
								...
								<div className="flex items-center justify-between text-emerald-600 text-sm">
									<span className="flex items-center">
										<Icon icon="mdi:bed" className="mr-1 h-4 w-4" />3 Beds
									</span>
									<span className="flex items-center">
										<Icon icon="mdi:shower" className="mr-1 h-4 w-4" />3 Baths
									</span>
									<span className="flex items-center">
						...
						<Card className="overflow-hidden border-emerald-200 bg-white transition-shadow hover:shadow-xl">
							<div className="relative">
								...
								<Badge className="absolute top-3 left-3 bg-emerald-500 text-white">
									<Icon icon="mdi:leaf" className="mr-1 h-3 w-3" />
									Eco-Friendly
								</Badge>
								<div className="absolute top-3 right-3 rounded-full bg-white/90 p-2 backdrop-blur-sm">
									<Icon icon="mdi:heart-outline" className="h-4 w-4 text-emerald-600" />
							...
							<CardContent className="px-6 py-4">
								<div className="mb-2 flex items-center justify-between">
									<h3 className="font-semibold text-emerald-900">Garden Apartment</h3>
								...
								<div className="flex items-center justify-between text-emerald-600 text-sm">
									<span className="flex items-center">
										<Icon icon="mdi:bed" className="mr-1 h-4 w-4" />1 Bed
									</span>
									<span className="flex items-center">
										<Icon icon="mdi:shower" className="mr-1 h-4 w-4" />1 Bath
									</span>
									<span className="flex items-center">
										<Icon icon="mdi:flower" className="mr-1 h-4 w-4" />
										Garden
									</span>
								</div>
							</CardContent>
				...
				<div className="container mx-auto text-center">
					<div className="mx-auto max-w-3xl">
						...
						<p className="mb-8 text-emerald-100 text-lg">
							Meet Nyumba, your intelligent property assistant that understands your needs and
							preferences to find the perfect rental match.
						</p>
						<Card className="mx-auto max-w-2xl border-emerald-300/20 bg-white/10 text-white backdrop-blur-md">
							<CardContent className="px-6 py-8">
								...
								<div className="mb-4 rounded-lg bg-white/10 p-4 text-left">
									<p className="text-sm">
										"I found 3 properties in Westlands that match your budget of KES 80,000 and
										preference for modern amenities. Would you like me to schedule virtual tours?"
									</p>
								</div>
								<div className="flex gap-2">
									<Input
			...
			<section className="bg-white/50 px-4 py-16">
				<div className="container mx-auto">
					<div className="mb-12 text-center">
						...
						<p className="mx-auto max-w-2xl text-emerald-700">
							Experience the future of property rental with our innovative features designed for the
							Kenyan market
						</p>
					</div>
					<div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card className="border-emerald-200 bg-white text-center transition-shadow hover:shadow-lg">
							<CardContent className="px-6 py-8">
								<div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-600">
									<Icon icon="mdi:phone" className="h-8 w-8 text-white" />
								</div>
								<h3 className="mb-2 font-heading font-semibold text-emerald-900">
									M-Pesa Integration
								</h3>
						...
						<Card className="border-emerald-200 bg-white text-center transition-shadow hover:shadow-lg">
							<CardContent className="px-6 py-8">
								<div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-600">
									<Icon icon="mdi:translate" className="h-8 w-8 text-white" />
								</div>
								<h3 className="mb-2 font-heading font-semibold text-emerald-900">
									Local Languages
								</h3>
						...
						<Card className="border-emerald-200 bg-white text-center transition-shadow hover:shadow-lg">
							<CardContent className="px-6 py-8">
								<div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-emerald-500 to-teal-600">
									<Icon icon="mdi:security" className="h-8 w-8 text-white" />
								</div>
								<h3 className="mb-2 font-heading font-semibold text-emerald-900">Safe & Secure</h3>
								<p className="text-emerald-700 text-sm">
				...
				<div className="container mx-auto text-center">
					<div className="mx-auto max-w-3xl">
						...
						<p className="mb-8 text-emerald-700 text-lg">
							Join thousands of satisfied tenants who found their perfect rental through NyumbaAI
						</p>
