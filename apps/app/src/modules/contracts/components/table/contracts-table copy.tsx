...
const mockProperties = {
  "1": { name: "Sunset Apartments", address: "123 Main St" },
  "2": { name: "Ocean View Complex", address: "456 Beach Rd" },
};
...
export function ContractsTable({
  ...
  const getTenantNames = (tenantIds: string[]) =>
    tenantIds
      .map((id) => {
        const tenant = mockTenants[id as keyof typeof mockTenants];
    ...
    () => [
      ...
      // Property column
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="font-medium">{getPropertyName(propertyId)}</div>
          );
        },
      },
      // Tenants column
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Contracts</CardTitle>
        <CardDescription>Manage and view your rental contracts</CardDescription>
      </CardHeader>
      <CardContent>
