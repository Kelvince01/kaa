...
type InteractiveAnalyticsDashboardProps = {
  className?: string;
};
...
export function InteractiveAnalyticsDashboard({
  ...
  const exportData = () => {
    ...
    a.href = url;
    a.download = `financial-analytics-${format(new Date(), "yyyy-MM-dd")}.json`;
    a.click();
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Real-time financial insights with dynamic filtering
          </p>
        </div>
