...
import { TenantsTableActionBar } from "./action-bar";
import { TenantsTableToolbarActions } from "./toolbar-actions";
...
export function TenantsTable({ data, onCreate, onDelete, pageCount }: TenantsTableProps) {
	const [rowAction, setRowAction] = React.useState<DataTableRowAction<Tenant> | null>(null);
