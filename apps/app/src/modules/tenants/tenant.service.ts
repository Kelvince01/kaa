...
// Create tenant
export const createTenant = async (data: TenantCreateInput): Promise<TenantResponse> => {
	const response = await httpClient.api.post("/tenants", data);
	return response.data;
};

// Get all tenants (with optional filters)
export const getTenants = async (params: any = {}): Promise<TenantListResponse> => {
...
// Search tenants
export const searchTenants = async (params: any = {}): Promise<TenantListResponse> => {
