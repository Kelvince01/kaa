...
export class AmenityService {
	...
	static async getNearbyAmenities(query: NearbyAmenitiesQuery): Promise<{
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/nearby`, {
			params: query,
		});
	...
	static async getNearbyAmenitiesGrouped(
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/nearby/grouped`, {
			params: {
				latitude,
				longitude,
				radius,
	...
	static async getPropertyAmenities(
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/property/${propertyId}`, {
			params: { radius },
		});
	...
	static async calculateAmenityScore(
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/score`, {
	...
	static async searchAmenities(
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/search`, {
			params: {
				q: query,
				...filters,
			},
	...
	static async getAmenitiesByCounty(
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/county/${county}`, {
	...
	static async getAreaStats(
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/stats/${county}`, {
			params: { ward },
		});
	...
	static async getMetadata(): Promise<AmenityMetadata> {
		const response = await httpClient.api.get(`${this.BASE_URL}/metadata`);
		return response.data.data;
	}
	 ...
	 */
	static async createAmenity(amenityData: CreateAmenityRequest): Promise<Amenity> {
		const response = await httpClient.api.post(this.BASE_URL, amenityData);
		return response.data.data;
	}
	...
	static async updateAmenity(
		...
		const response = await httpClient.api.put(`${this.BASE_URL}/${amenityId}`, amenityData);
		return response.data.data;
	}
	...
	static async deleteAmenity(amenityId: string): Promise<void> {
		await httpClient.api.delete(`${this.BASE_URL}/${amenityId}`);
	}
	...
	static async getPendingAmenities(
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/pending`, {
			params: options,
		});
	 ...
	 * Approve an amenity
	 */
	static async approveAmenity(amenityId: string, notes?: string): Promise<Amenity> {
		const response = await httpClient.api.post(`${this.BASE_URL}/${amenityId}/approve`, {
			notes,
		});
		return response.data.data;
	}
	 ...
	 * Reject an amenity
	 */
	static async rejectAmenity(amenityId: string, reason: string): Promise<Amenity> {
		const response = await httpClient.api.post(`${this.BASE_URL}/${amenityId}/reject`, {
			reason,
		});
		return response.data.data;
	}
	...
	static async bulkApproveAmenities(amenityIds: string[]): Promise<{
		...
		const response = await httpClient.api.post(`${this.BASE_URL}/bulk-approve`, {
			amenityIds,
		});
		return response.data.data;
	}
	...
	static async getApprovalStats(county?: string): Promise<{
		...
		approved: number;
		rejected: number;
		bySource: Record<AmenitySource, { pending: number; approved: number; rejected: number }>;
	}> {
		const response = await httpClient.api.get(`${this.BASE_URL}/approval-stats`, {
			params: { county },
		});
		return response.data.data;
	}
	...
	static async verifyAmenityWithLevel(
		...
		const response = await httpClient.api.post(`${this.BASE_URL}/${amenityId}/verify-enhanced`, {
			verificationLevel,
			notes,
		});
		return response.data.data;
	...
	static async getAmenitiesByDiscoveryStatus(
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/by-discovery-status`, {
			params: {
	...
	static async getVerificationStats(county?: string): Promise<{
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/verification-stats`, {
			params: { county },
		});
		return response.data.data;
	}
	...
	static async discoverAmenities(request: DiscoveryRequest): Promise<{
		...
		const response = await httpClient.api.post(`${this.BASE_URL}/discover`, request);
		return response.data.data;
	}
	...
	static async discoverPropertyAmenities(
		...
		const response = await httpClient.api.post(`${this.BASE_URL}/discover/property/${propertyId}`, {
			radius,
			autoSave,
	...
	static async getAutoPopulationStatus(): Promise<{
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/auto-population/status`);
		return response.data.data;
	}
	...
	static async getAutoDiscoveryStats(county?: string): Promise<{
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/auto-population/stats`, {
			params: { county },
		});
		return response.data.data;
	}
	...
	static async validateAmenityData(county?: string): Promise<{
		...
		const response = await httpClient.api.get(`${this.BASE_URL}/auto-population/validate`, {
			params: { county },
		});
		return response.data.data;
	}
	...
	static async discoverMissingAmenities(
		...
		const response = await httpClient.api.post(
			`${this.BASE_URL}/auto-population/discover-missing`,
			{
				county,
				batchSize,
				maxProperties,
