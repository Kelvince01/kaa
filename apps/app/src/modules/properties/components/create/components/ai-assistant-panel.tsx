					...
					<div className="grid grid-cols-1 gap-4 md:grid-cols-3">
						...
						<div>
							...
							<Select
								...
								onValueChange={(value) => setSelectedLength(value as "short" | "medium" | "long")}
							>
								<SelectTrigger>
									<SelectValue />
								</SelectTrigger>
					...
					{generatedDescription && (
						<div className="rounded-lg bg-gray-50 p-4">
							<div className="mb-2 flex items-center justify-between">
								<span className="font-medium text-sm">Generated Description</span>
				...
				<CardContent className="space-y-4">
						...
						<div className="space-y-4">
							<div className="grid grid-cols-1 gap-4 md:grid-cols-3">
								<div className="text-center">
									<div className={cn("font-bold text-2xl", getScoreColor(analysis.score))}>
										{analysis.score}%
									</div>
								...
								<div className="text-center">
									<div
										className={cn("font-bold text-2xl", getScoreColor(analysis.readabilityScore))}
									>
								...
								<div className="text-center">
									<div className={cn("font-bold text-2xl", getScoreColor(analysis.seoScore))}>
										{analysis.seoScore}%
									</div>
					...
					{seoOptimization && (
						<div className="rounded-lg bg-green-50 p-4">
							<div className="mb-2 flex items-center justify-between">
								<span className="font-medium text-green-800 text-sm">SEO Optimized Content</span>
								<Button
									size="sm"
									variant="outline"
							...
							<p className="mb-2 text-green-700 text-sm">{seoOptimization.optimizedContent}</p>
							<div className="text-green-600 text-xs">
								<strong>Improvements:</strong> {seoOptimization.improvements.join(", ")}
							</div>
						</div>
					)}
				</CardContent>
						...
						<div className="space-y-4">
							<div className="rounded-lg bg-blue-50 p-4 text-center">
								...
								<div className="mt-1 text-gray-500 text-xs">
									Range: KES {pricingSuggestion.range.min.toLocaleString()} - KES{" "}
