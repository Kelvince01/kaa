...
import { PropertyCompare } from "./property-compare";

// This is an example of how to use the PropertyCompare component
// You can copy and modify this code for your specific use case
//
// Features demonstrated:
// - Property selection with recently viewed integration
// - Enhanced charts with shadcn/ui components
// - Multiple view modes (table, cards, charts)
// - Automatic tracking of viewed properties

const PropertyComparisonExample: React.FC = () => {
  // Mock data - replace with your actual property data
  const mockProperties: Property[] | any[] = [
    {
      _id: "1",
...
export default PropertyComparisonExample;

// Usage in a page component:
/*
import PropertyComparisonExample from '@/modules/properties/components/compare/example';
...
/*
const customFields = [
	{ key: "title", label: "Property Name", category: "Basic", type: "text", important: true },
	{ key: "pricing.rentAmount", label: "Monthly Rent", category: "Cost", type: "price", important: true },
	{ key: "details.bedrooms", label: "Bedrooms", category: "Space", type: "number", important: true },
	{ key: "details.bathrooms", label: "Bathrooms", category: "Space", type: "number", important: true },
	{ key: "location.county", label: "County", category: "Location", type: "text", important: true },
