...
declare module "@/components/common/blocknote/types" {
  // biome-ignore lint/nursery/useConsistentTypeDefinitions: blocknote types
...
export const allowedFileTypes: BasicFileBlockTypes[] = [
  "image",
  "video",
  "audio",
  "file",
];
export const allowedTypes: (BasicBlockBaseTypes | KaaCustomBlockTypes)[] = [
  "notify",
  "table",
  "emoji",
  "paragraph",
...
export const customBlockTypeSelectItems: (
  | BasicBlockTypes
  | KaaCustomBlockTypes
)[] = [
  "heading",
...
export const sideMenuOpenOnTypes: (BasicBlockTypes | KaaCustomBlockTypes)[] = [
  "paragraph",
  "heading",
  "bulletListItem",
  "numberedListItem",
...
export const getSideMenuItems = (dict: Dictionary) => [
...
export const customSlashNotIndexedItems: MenusItemsTitle[] = [
  "Table",
  "Audio",
  "Heading 1",
  "Heading 2",
...
export const formattingToolBarTextAlignItems: BlockAlignTypes[] = [
  "left",
  "center",
  "right",
];
...
export const formattingToolBarTextStyleSelect: BlockStyleTypes[] = [
  "bold",
  "italic",
  "underline",
  "strike",
...
export const formattingToolBarStyleForBlocks: BasicBlockTypes[] = [
  "heading",
  "paragraph",
  "bulletListItem",
  "numberedListItem",
