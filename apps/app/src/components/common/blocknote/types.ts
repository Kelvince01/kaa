...
import type { customSchema } from "@/components/common/blocknote/blocknote-config";

export type CustomBlockNoteSchema = typeof customSchema.BlockNoteEditor;

export type CustomFormatToolBarConfig = {
...
export type BasicBlockBaseTypes =
  | "emoji"
  | "table"
  | "paragraph"
  | "heading"
...
export type KaaCustomBlockTypes = ExtendableBlocknoteTypes["BlockTypes"];
