...
export const STANDARD_HOTKEYS: {
...
}[] = [
  {
    ...
    hotkeys: [
      ...
      {
        id: "SNAP_PREVIEW_LEFT",
        key: "alt+left",
        description: "Snap previewer to the left",
      },
      {
        id: "SNAP_PREVIEW_RIGHT",
        key: "alt+right",
        description: "Snap previewer to the right",
      },
    ...
    hotkeys: [
      {
        id: "TOGGLE_VIEWPORT",
        key: "alt+1",
        description: "Toggle viewport menu",
      },
      {
        id: "VIEWPORT_DESKTOP",
        key: "alt+d",
        description: "Switch to desktop preset",
      },
      {
        id: "VIEWPORT_MOBILE",
        key: "alt+m",
        description: "Switch to mobile preset",
      },
      { id: "VIEWPORT_WIDTH", key: "alt+w", description: "Focus width input" },
      {
        id: "VIEWPORT_HEIGHT",
        key: "alt+h",
        description: "Focus height input",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    hotkeys: [
      ...
      },
      {
        id: "LIQUID_GENERATE",
        key: "alt+g",
        description: "Generate Ascenda template",
      },
  ...
  },
  {
    ...
    hotkeys: [
      {
        id: "TOGGLE_PREVIEW_SCALE",
        key: "alt+f",
        description: "Toggle preview scale mode",
      },
...
export const HOTKEYS: Record<
  string,
  { key: string; description: string; hint: string }
> = {
  ...Object.fromEntries(
...
export const DEFAULT_LOCAL_LIQUID: Record<string, unknown> = {
  ...
  features: [
    { title: "Trying out different viewports", shortcut: "alt + 1" },
    {
      ...
      shortcut: "alt + 2",
      description:
        "Local liquids carry the concept of more dynamic attributes, while shared liquids carry the concept of more static attributes. At it's core, both evaluate to the same JSON data.",
    },
    {
      title: "Quick copying MJML, HTML, local & shared liquid",
      shortcut: "alt + 3",
    },
...
export const ASCENDA_LIQUID_TEMPLATE: Record<string, unknown> = {
  ...
  theme_brand_header_font_family_url:
  ...
  theme_brand_body_font_family_url:
    "https://fonts.googleapis.com/css2?family=Lexend:wght@400;700&display=swap",
