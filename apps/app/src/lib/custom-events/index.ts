import type {
  CombinedCustomEventMap,
  CustomEventsWithData,
} from "@/lib/custom-events/types";
...
export function dispatchCustomEvent<
  EventName extends keyof CombinedCustomEventMap,
>(
  eventName: EventName,
  eventData?: EventName extends keyof CustomEventsWithData
    ? CustomEventsWithData[EventName]
    : never
): void {
