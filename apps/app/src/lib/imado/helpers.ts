 ...
 */
export const transformUploadedFile = (
...
const readJwt = (token: string) =>
  JSON.parse(atob(token.split(".") as unknown as string[1]));
 ...
 */
export const prepareFilesForOffline = async (
 ...
 */
export const createBaseTusUppy = (
