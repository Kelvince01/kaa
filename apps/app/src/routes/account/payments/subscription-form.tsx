...
} from "@/modules/subscriptions/subscriptions.type";
...
const SubscriptionForm: React.FC<SubscriptionFormProps> = ({
	...
	const onSubmit = async (data: SubscriptionFormData) => {
		...
		try {
			...
			const response = await httpClient.api.post<GetSubscriptionResponse>("/subscriptions", {
				propertyId,
			...
			const errorMessage = error.message || "An error occurred setting up the recurring payment";
			...
			<Form {...form}>
				<form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
							...
							<FormField
								...
								render={({ field }) => (
									<FormItem>
										...
										<FormControl>
											<Input id="endDate" type="date" {...field} value={field.value || ""} />
										</FormControl>
										<FormMessage />
									</FormItem>
								)}
					...
					<div className="space-y-2">
						...
						<PaymentMethodsList selectable onSelect={handlePaymentMethodSelect} />
					</div>
