...
export function DashboardStats() {
  return (
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card className="border-0 bg-linear-to-br from-amber-500 to-orange-500 text-white">
        <CardContent className="px-6">
          <div className="flex items-center justify-between">
            <div>
      ...
      <Card className="border-0 bg-linear-to-br from-blue-500 to-cyan-500 text-white">
        <CardContent className="px-6">
          <div className="flex items-center justify-between">
            <div>
      ...
      <Card className="border-0 bg-linear-to-br from-purple-500 to-pink-500 text-white">
        <CardContent className="px-6">
          <div className="flex items-center justify-between">
            <div>
