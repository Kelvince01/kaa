					...
					<div className="space-y-8">
						<div className="search-container space-y-6">
							...
							<p className="text-emerald-700 text-xl leading-relaxed">
								Harness the power of AI to automate tenant screening, optimize rent pricing, and
								manage your properties like never before. Built specifically for the Kenyan rental
								market.
							</p>
						</div>
						...
						<div className="flex items-center space-x-8 pt-4">
							<div className="text-center">
								...
								<div className="text-emerald-600 text-sm">Properties Managed</div>
							</div>
							<div className="text-center">
								<div className="font-bold text-2xl text-emerald-800">98%</div>
								<div className="text-emerald-600 text-sm">Tenant Satisfaction</div>
							</div>
							<div className="text-center">
							...
							<CardContent className="p-8">
								<div className="space-y-6">
									<div className="flex items-center justify-between">
										<h3 className="font-semibold text-emerald-800 text-xl">AI Dashboard</h3>
									...
									<div className="grid grid-cols-2 gap-4">
										<div className="rounded-lg bg-emerald-50 p-4">
											<div className="mb-2 flex items-center space-x-2">
												...
												/>
												<span className="text-emerald-700 text-sm">Occupancy Rate</span>
											</div>
											<div className="font-bold text-2xl text-emerald-800">94%</div>
										</div>
										<div className="rounded-lg bg-emerald-50 p-4">
											<div className="mb-2 flex items-center space-x-2">
												<Icon
													...
													className="h-5 w-5 text-emerald-600"
												/>
												<span className="text-emerald-700 text-sm">Monthly Revenue</span>
											</div>
									...
									<div className="space-y-3">
										<div className="flex items-center justify-between">
											<span className="text-emerald-700 text-sm">AI Tenant Screening</span>
											<span className="font-medium text-emerald-800 text-sm">Active</span>
										</div>
										<Progress value={85} className="h-2" />
										<div className="flex items-center justify-between">
											<span className="text-emerald-700 text-sm">Rent Optimization</span>
											<span className="font-medium text-emerald-800 text-sm">Running</span>
										</div>
