  ...
  },
  {
    ...
    links: [
      { title: "common.api_docs", href: `${config.backendUrl}/docs` },
      {
        ...
        href: "https://github.com/Kelvince01/kaa/blob/main/info/ARCHITECTURE.md",
      },
      {
        title: "common.roadmap",
        href: "https://github.com/Kelvince01/kaa/blob/main/info/ROADMAP.md",
      },
    ],
  },
  {
