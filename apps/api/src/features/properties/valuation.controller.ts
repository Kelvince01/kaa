...
export const valuationController = new Elysia({
  detail: {
    tags: ["valuations"],
    summary: "Property valuations",
    description: "Property valuations endpoints",
    security: [{ bearerAuth: [] }],
  },
}).group("/properties/valuations", (app) =>
  app
    ...
    .post(
      ...
      async ({ params }) =>
        await PropertyValuationService.generateMarketAnalysis(
          params.propertyId
        ),
      {
        params: t.Object({
    ...
    .post(
      ...
      async ({ params }) =>
        await PropertyValuationService.generateRentalEstimate(
          params.propertyId
        ),
      {
        params: t.Object({
    ...
    .get(
      ...
      async ({ params }) =>
        await PropertyValuationService.getPortfolioValuation(
          params.portfolioId
        ),
      {
        params: t.Object({
    ...
    .post(
      "/import",
      async ({ body }) =>
        await PropertyValuationService.importValuations(
          body.file,
          body.options
        ),
      {
